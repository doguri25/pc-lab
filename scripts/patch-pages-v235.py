...
s=p.read_text()
old='<title>PC LAB v2.3.4 — 컴퓨터 조립 시뮬레이터</title><meta name="pc-lab-version" content="2.3.4"><meta name="pc-lab-build" content="2.3.4-4490bd72e3c7">'
...
entry={'version':'2.3.5','date':'2026-09-14','timezone':'Asia/Seoul','channel':'stable-local','title':'확대 작업 헤더 버튼 안쪽 정렬 보정','changes':['확대 작업 헤더 좌우 버튼을 배경선에서 8px 안쪽으로 배치','기존 버튼 축소·말줄임 규칙을 유지하면서 헤더 폭과 내부 여백 계산을 보정','데스크톱·태블릿·모바일에서 두 버튼이 헤더 배경선 안쪽에 유지되도록 수정'],'scopeNote':'로컬 학습용 PC 조립 시뮬레이터.'}
